...
/* feed.rss.twig */
class __TwigTemplate_beb66527f23bb83b0787b18df8b9852bbceb1d9ccf7e53449f1eadba48e86ed7 extends Twig_Template
{
    ...
    <channel>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            ...
            if ((isset($context["banner"]) ? $context["banner"] : null)) {
                // line 18
                echo "                ";
                echo $this->env->getExtension('GravTwigExtension')->absoluteUrlFilter($this->getAttribute($this->getAttribute((isset($context["banner"]) ? $context["banner"] : null), "cropZoom", array(0 => 600, 1 => 400), "method"), "html", array()));
                echo "
                ";
            }
            // line 20
            echo "                ";
            echo call_user_func_array($this->env->getFilter('truncate_html')->getCallable(), array($this->getAttribute($context["item"], "summary", array()), $this->getAttribute($this->getAttribute((isset($context["collection"]) ? $context["collection"] : null), "params", array()), "length", array())));
            echo "
                ]]>
            </description>
            <category>";
